...
#
# John = User('jcollins1995', 'kolejnehaslo')
# John.save_to_db(cursor)
# # #
# # # test = User.load_user_by_id(cursor, 2)
# # # test.username = 'mszczesniak89'
# # # test.save_to_db(cursor)
# # #
# #
# # test = User.load_user_by_id(cursor, 4)
# # test.delete(cursor)
# #
# #
#
